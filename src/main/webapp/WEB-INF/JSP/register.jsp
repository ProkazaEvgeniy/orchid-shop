...
<!-- CSS -->
<link rel="stylesheet" type="text/css" href="/static/css/app-register.css" />
<!-- /CSS -->
<div class="orchid-register">
	...
	<div>
		...
		<div class="col-md-10">
			<label class="radio"> <input type="radio" name="sex" id="sex" value="male" checked> Male
			</label> <label class="radio"> <input type="radio" name="sex" id="Radio1" value="female"> Female
			</label>
		</div>
	</div>
	<div>
	...
	<div>
		...
		<div class="col-md-10">
			<label> <input type="checkbox">I hereby accept the terms and conditions for using this site
			</label>
		</div>
	</div>
	<div class="row">
